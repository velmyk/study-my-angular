...
describe("Scope", function() {
	...
	describe("$digest", function() {
		...
		it("does not end digest so that new watches are not run", function() { scope.aValue = 'abc';
			scope.counter = 0;
			scope.$watch(
				function(scope) {
					return scope.aValue;
	...
	describe('destroying watchers', function(){
		beforeEach(function(){
			scope = new Scope();
		});
	...
	describe('$watchGroup', function() {
		...
		it('can be deregistered', function() { var counter = 0;
			scope.aValue = 1;
			scope.anotherValue = 2;
